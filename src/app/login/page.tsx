...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen relative">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-ember/[0.04] rounded-full blur-[120px]" />
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="text-center mb-8 animate-fade-slide-up">
            ...
            <p className="text-sm text-muted mt-2">
              Access your staffing dashboard
            </p>
          </div>
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 bg-ember hover:bg-ember-glow disabled:bg-ember-dim text-white font-semibold rounded-md transition-all hover:shadow-[0_0_20px_rgba(249,115,22,0.3)] disabled:opacity-50"
            >
              {loading ? (
