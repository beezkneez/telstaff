        ...
        {groups.map((group) => (
          <div key={group.label} className="px-4 py-3">
            <div className="flex items-center gap-2 mb-2.5">
              <span className="inline-flex items-center px-2 py-0.5 text-[11px] font-mono tracking-[0.15em] uppercase border bg-surface-overlay/50 border-border text-muted">
                {group.label}
              </span>
            ...
            <div className="space-y-px">
              {group.members.map((member, idx) => (
                ...
                >
                  ...
                  <span className="font-mono text-[11px] tracking-wider uppercase text-muted shrink-0 ml-2">
                    {member.rank}
                  </span>
                </div>
              ))}
