...
export default function StationDropdown({
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute top-full left-0 mt-1 w-56 max-h-72 overflow-y-auto bg-surface-raised border border-border rounded-lg shadow-2xl shadow-black/50 z-50 animate-fade-in">
          <div className="p-1.5">
